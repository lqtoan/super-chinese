...
export const HSK2_CURRICULUM_AUDIOS: Audio[] = [
  ...
  {
    title: '01-1',
    url: 'assets/curriculum/hsk2/01-1.mp3',
    text: [
      '我要去北京旅游， 你觉得什么时候去最好？',
      '九月去北京 旅游最好。',
      '为什么？',
  ...
  {
    title: '01-2',
    url: 'assets/curriculum/hsk2/01-2.mp3',
    text: ['你喜欢什么运动？', '我最喜欢踢足球。', '下午我们一起去踢足球吧。', '好啊！'],
  },
  {
    title: '01-3',
    url: 'assets/curriculum/hsk2/01-3.mp3',
    text: ['我们要不要买几个新的椅子？', '好啊。 什么时候去买？', '明天下午怎么样？ 你明天几点能回来？', '三点多。'],
  },
  {
    title: '01-4',
    url: 'assets/curriculum/hsk2/01-4.mp3',
    text: [
      '桌子下面有个猫。',
      '那是我的猫， 它叫花花。',
      '它很漂亮。',
  ...
  },
  {
    ...
    text: ['吃药了吗？ 现在身体怎么样？', '吃了。 现在好多了。', '什么时候能出院？', '医生说下个星期。'],
  },
  {
    title: '02-3',
    url: 'assets/curriculum/hsk2/02-3.mp3',
    text: ['大卫今年多大？', '二十多岁。', '他多高？', '一米八几。', '你怎么知道这么多啊？', '他是我同学。'],
  },
  {
    title: '02-4',
    url: 'assets/curriculum/hsk2/02-4.mp3',
    text: ['张老师星期六也不休息啊？', '是啊， 他这几天很忙， 没有时间休息。', '那会很累吧？', '他每天回来都很累。'],
  },
  {
    title: '02-5',
  ...
  },
  {
    ...
    text: ['你知道小王今天什么时候来学校吗？', '他已经来了', '你怎么知道他来了？', '我在门外看见他的自行车了。'],
  },
  {
    title: '06-2',
  ...
  },
  {
    ...
    text: ['这两天怎么没看见小张？', '他去北京了。', '去北京了？ 是去旅游吗？', '不是， 听说是去看他姐姐。'],
  },
  {
    title: '06-5',
  ...
  },
  {
    ...
    text: ['服务员， 我房间的门打不开了。', '您住哪个房间？', '317', '好的， 我叫人去看看。'],
  },
  {
    title: '08-4',
  ...
  },
  {
    ...
    text: ['你好！ 请问张欢在吗？', '你打错了， 我们这儿没有叫张欢的。', '对不起。'],
  },
  {
    title: '09-2',
  ...
  },
  {
    ...
    text: ['昨天的考试怎么样？ 你都听懂了吗？', '听懂了。', '你都做完了没有？', '踢太多， 我没做完。'],
  },
  {
    title: '09-5',
